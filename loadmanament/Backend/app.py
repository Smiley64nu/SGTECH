...
from power_calculation import process_power_data,calculate_time_period,calculate_power,calculate_difference
from pymongo import MongoClient
...
def calculate_power_api():
    data = request.json
    Psh = data.get('Psh', 4)#power of  peak shaving kW
